$(document).ready(function(){
    ...
    socket.on('loggedInUser', function(users, image){
        ...
        for(var i = 0; i < users.length; i++){
            if(f.indexOf(users[i]) > -1){
                ...
                var list = '<img src="https://soccerchatuser.s3.amazonaws.com/'+image+'" class="pull-left img-circle" style="width:50px;margin-right:10px" /><p>' +
