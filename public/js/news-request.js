...
function GetRequest(){
    ...
    $.ajax({
        url: 'https://content.guardianapis.com/football?page-size=200&order-by=newest&show-fields=all&api-key=8b435306-1b3a-480d-b96d-32b7d969507a',
        type: "GET",
        dataType: "json",
        success: function(data) {
            ...
            $.each(data.response.results, function(i){
                ...
                res += "<a href='"+data.response.results[i].webUrl+"' target='_blank' style='color:#4aa1f3 !important; text-decoration:none'>";
            ...
            for(var i = 0; i < data.response.results.length; i++){
                ...
                res1 += "<h3 class='mob-news-01' style='color:#4aa1f3; text-decoration:none'>"+data.response.results[i].fields.headline+"</h3>";
                res1 += "</div>";
